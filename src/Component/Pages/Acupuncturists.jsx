...
import Img from '../../assets/medical-img4.jpg';
import Uservideo from "../../assets/sample-video.mp4"
import Footer from '../Footer.jsx'
function Acupuncture({closeForm, submitForm }){
    return(
      <div>
      <Navbar/>
    ...
    <div className=" w-full lg:w-3/4 space-y-4">
      <h1 className=" text-4xl font-semibold text-center lg:text-start">About Acupuncture</h1>
