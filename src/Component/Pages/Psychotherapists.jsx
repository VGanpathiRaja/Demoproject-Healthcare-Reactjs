...
import Img from '../../assets/medical-img1.jpg';
import Uservideo from "../../assets/sample-video.mp4"
import Footer from '../Footer.jsx'
function Psychotherapy({ closeForm, submitForm }){
    return(
        <div>
        <Navbar/>
      ...
      <div className=" w-full lg:w-3/4 space-y-4">
        <h1 className=" text-4xl font-semibold text-center lg:text-start">About Psychotherapy</h1>
    ...
    <div className=" w-full lg:w-3/4 space-y-3">
      ...
      <div className="mt-12 text-black flex flex-col md:flex-row  justify-between items-center " >
